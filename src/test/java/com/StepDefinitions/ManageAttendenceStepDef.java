...
public class ManageAttendenceStepDef extends BaseClass {
	...
	@Given("Admin is on dashboard page after Login in to the LMS url ")
	public void admin_is_on_dashboard_page_after_login_in_to_the_LMS_url() throws InterruptedException {
